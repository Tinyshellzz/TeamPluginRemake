...
public class TeamMapper {
    ...
    public Team get_team_by_name(String name) {
        ...
        try {
            ...
            if(rs.next()) {
                team =  new Team(rs.getString(1), UUID.fromString(rs.getString(2)), rs.getString(3) == null ? null : UUID.fromString(rs.getString(3)), rs.getString(4), rs.getString(5) == null ? null : gson.fromJson(rs.getString(5), MyLocation.class), rs.getString(6), rs.getString(7));
            }
        } catch (SQLException e) {
